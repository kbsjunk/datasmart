	...
	grunt.initConfig({
		...
		options: {
			...
			css: {
				...
				files: ['assets/vendor/bootstrap/dist/css/bootstrap.min.css','assets/vendor/font-awesome/css/font-awesome.min.css','assets/vendor/highlightjs/styles/github.css','assets/css/main.css'],							// CSS files in order you'd like them concatenated and minified
			...
			js: {
				...
				files: ['assets/vendor/jquery/dist/jquery.js','assets/vendor/bootstrap/dist/js/bootstrap.min.js','assets/vendor/highlightjs/highlight.pack.js','assets/js/datasmart.js'],							// JavaScript files in order you'd like them concatenated and minified
